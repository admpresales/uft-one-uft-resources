WpfWindow("OpenText MyFlight Sample").WpfComboBox("fromCity").Select "Denver" @@ hightlight id_;_1958781272_;_script infofile_;_ZIP::ssf3.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfComboBox("toCity").Select "Frankfurt" @@ hightlight id_;_1958781800_;_script infofile_;_ZIP::ssf5.xml_;_
...
WpfWindow("OpenText MyFlight Sample").WpfTable("flightsDataGrid").SelectCell 2,0 @@ hightlight id_;_1958775896_;_script infofile_;_ZIP::ssf13.xml_;_
...
WpfWindow("OpenText MyFlight Sample").WpfEdit("passengerName").Set "John Jackson" @@ hightlight id_;_1997141616_;_script infofile_;_ZIP::ssf15.xml_;_
